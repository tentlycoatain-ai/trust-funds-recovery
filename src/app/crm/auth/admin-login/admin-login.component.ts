    ...
    <div class="login-wrapper">
      <div class="login-card">
        ...
        <form (ngSubmit)="onSubmit()" class="login-form">
          <div class="form-group">
            ...
            <input
              ...
              required
              class="form-control"
              placeholder="admin@trustfundsrecovery.com"
            />
          </div>
        ...
        <div class="login-footer">
          <a routerLink="/agent/login">Switch to Agent Portal <img class="real-icon real-icon-inline" src="/assets/icons/forward-card.png" alt="" aria-hidden="true" /></a>
...
export class AdminLoginComponent {
  ...
  onSubmit(): void {
    this.authService.login({ email: this.email, password: this.password }, 'admin');
  }

  quickLogin(): void {
    this.authService.quickLoginAs('admin');
  }
}
